    ...
    <section class="acc-content">
        ...
        <section id="acc-content-area">
            ...
            <?php } else {
            	...
            	<h1>Make an assistance request</h1>
            	...
            	<section id="form">
                    ...
                    <form action="" method="post">
                            ...
                            <?php if (count(AssistanceRequestController::$products) > 0) { 
                                foreach (AssistanceRequestController::$products as $k => $v) { 
                                    ...
                                    <div class="label-container">
                                        <label class="labely"><strong><?php echo $v->getName(); ?> (# <?php echo $v->getId(); ?>): </strong> <em><?php echo $v->getDesc(); ?></em></label>
                                    </div><br>
                                <?php } ?>
                            <?php } ?><br>
                        ...
                        <label>&nbsp;</label>
                        <input type="submit" value="Make Request"/><br>
                    </form>
                </section>
            <?php } ?>
        </section><br>
